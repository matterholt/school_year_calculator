...
<script>
 ...
 import { holidays } from '../helpers/us_national_holiday.json';
  import NationalHoliday from "./formSections/NationalHoliday.svelte";
  import DaysOff from "./formSections/DaysOff.svelte"
  ...
  $: NumberOfDaysWithNoScooling = [...selectedNationalHoliday,...plannedHolidays,...unplannedHolidays].length
...
<main>
<div>
Calcualted days with no schooling: {NumberOfDaysWithNoScooling}
</div>
  ...
  <section>
    ...
    <input type="number" id="sessionsPerWeek" bind:value={sessionsPerWeek} min="1" >
    ...
    <section>
    <NationalHoliday {holidays}  bind:selectedDays = {selectedNationalHoliday}/>
    </section>
